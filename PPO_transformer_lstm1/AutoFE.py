...
from PPO_transformer_lstm1.fe_operations import get_binning_df
...
class AutoFE:
    ...
    def fit_attention(self, args):
        ...
        self.ppo = PPO(args, data_nums,feature_nums,operations_c, operations_d, d_model, d_k, d_v, d_ff, n_heads, self.device)
