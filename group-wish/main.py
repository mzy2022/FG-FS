...
def train(param):
    ...
    while episode < EPISODES:
        ...
        while step < STEPS:
            ...
            info('New performance is: {:.6f}, Best performance is: {:.6f} (e{}s{}) Base performance is: {:.6f}'.format(new_per, best_per, best_episode, best_step, base_per))
    ...
    info('Total training time for is: {:.1f}s'.format(time.time() - training_start_time))
