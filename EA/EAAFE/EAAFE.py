...
import geatpy as ea
import pickle
from EA.util import convert_to_transform_dict
from EA.util import get_evaluator_class_from_module
import logging
...
class search_pipeline(ea.Problem):
    def __init__(self, config):
        ...
        self.len = self.CATS_NUM * config['search_params_dict']['c_orders'] + self.NUMS_NUM * \
                   config['search_params_dict']['n_orders']
                ...
                for action in actions:
                    ...
                    if fe2Name in self.cat_columns:
                        ...
                        if action_binary == 0:
                            ...
                            actions2ops.append(self.transform_dict['cat2cat'][action_binary].__repr__() + '(' + str(fe2Name) + ')')
                        ...
                        if action_binary == 0:
                            ...
                            actions2ops.append(self.transform_dict['cat2num'][action_binary].__repr__() + '(' + str(fe2Name) + ')')
    ...
    def aimFunc(self, pop):
        ...
        with parallel_backend("multiprocessing", n_jobs=1):
            fitness = Parallel()(delayed(self.evaluate)(Var) for Var in Vars)
...
class SEARCH_FE_PIPELINE(object):
    ...
    def run(self):
        ...
        for i in range(problem.FES_NUM):
            ...
            curr_field = ea.crtfld(Encodings[i], problem.varTypes[curr_index], problem.ranges[:, curr_index],problem.borders[:, curr_index])
