...
from DIFFER.autolearn.utils import log
from DIFFER.autolearn.utils.torch_attention import Attention
...
if __name__ == '__main__':
    def main():
        ...
        from DIFFER.autolearn.feat_selection.dataset import SequenceDataset
        from DIFFER.autolearn.utils import torch_train
        ...
        for op in op_info:
            op_arity[op[0]] = op[1]
            op_order[op[0]] = op[2]
        sentences = [random_generate_tree(feats, ops, op_arity, op_order, type_dict, max_order=4).post_order()[0] for _
                     in range(20)]
        tokenizer = Tokenizer(
