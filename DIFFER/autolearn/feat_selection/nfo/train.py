...
from DIFFER.autolearn.feat_selection.nfo.feat_tree import random_generate_tree, generate_tree_from_str
from DIFFER.autolearn.feat_selection.nfo.tokenizer import Tokenizer
from DIFFER.autolearn.feat_selection.nfo.controller import NFOController, Mode
from DIFFER.autolearn.utils import Config, torch_train, timeit, log, get_time_budget, set_time_budget
from DIFFER.autolearn.feat_selection.env import Environment
from DIFFER.autolearn.feat_selection.dataset import PlainDataset, SequenceDataset
...
def parse_args():
    ...
    parser.add_argument('--data', type=str,default='586', help='dataset name')
