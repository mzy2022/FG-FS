...
from DIFFER.autolearn.utils import Config, multi_train, timeit, log, get_time_budget, set_time_budget
from DIFFER.autolearn.feat_selection.env import SklearnEnv
from DIFFER.autolearn.feat_selection.dataset import MixDataset
...
def parse_args():
    ...
    parser.add_argument('--data', type=str, default='svmguide3',help='dataset name')
    ...
    parser.add_argument('--feat_pool', type=str, default='D:/python files/pythonProject3/DIFFER/autolearn/log')
