...
class DQN_ops(object):
    def __init__(self, args, data_nums, feature_nums,operations_c, operations_d, d_model, d_k, d_v, d_ff, n_heads,
        ...
        self.nums = max(self.ops_c_num,self.ops_d_num)
        ...
        self.agent1 = Actor1(args, data_nums, feature_nums,self.nums, d_model, d_k, d_v, d_ff, n_heads, device,dropout=dropout).to(self.device)
