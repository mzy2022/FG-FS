...
class PPO_psm(object):
    ...
    def feature_search(self):
        ...
        if self.eval_method == 'mse':
            flag = -1
        elif self.eval_method == 'f1_score' or self.eval_method == 'r_squared' or self.eval_method == 'acc' or self.eval_method == 'auc' or self.eval_method == 'ks' or self.eval_method == 'sub_rae':
            flag = 1
